...
_INDEX_RST_BADGE_CODECOV = '''.. image:: https://img.shields.io/codecov/c/gh/hendrikdutoit/fixdate
    :alt: CodeCov
    :target: https://app.codecov.io/gh/hendrikdutoit/fixdate

'''
_INDEX_RST_BADGE_GITHUB_CI = '''.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/fixdate/CI
    :alt: GitHub Actions - CI
    :target: https://github.com/hendrikdutoit/fixdate/actions/workflows/ci.yaml

'''
_INDEX_RST_BADGE_GITHUB_HITS = '''.. image:: https://img.shields.io/github/search/hendrikdutoit/fixdate/GitHub hit
    :alt: GitHub Searches

'''
_INDEX_RST_BADGE_GITHUB_LICENSE = '''.. image:: https://img.shields.io/github/license/hendrikdutoit/fixdate
    :alt: License

'''
_INDEX_RST_BADGE_GITHUB_ISSUES = '''.. image:: https://img.shields.io/github/issues-raw/hendrikdutoit/fixdate
    :alt: GitHub issues

'''
_INDEX_RST_BADGE_GITHUB_PRE_COMMIT = '''.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/fixdate/Pre-Commit
    :alt: GitHub Actions - Pre-Commit
    :target: https://github.com/hendrikdutoit/fixdate/actions/workflows/pre-commit.yaml

'''
_INDEX_RST_BADGE_GITHUB_RELEASE = '''.. image:: https://img.shields.io/github/v/release/hendrikdutoit/fixdate
    :alt: GitHub release (latest by date)

'''
_INDEX_RST_BADGE_PYPI_VERSION = '''.. image:: https://img.shields.io/testpypi/v/fixdate
    :alt: PyPi

'''
_INDEX_RST_BADGE_PYPI_DL = '''.. image:: https://img.shields.io/pypi/dm/fixdate
    :alt: PyPI - Downloads

'''
_INDEX_RST_BADGE_PYPI_STATUS = '''.. image:: https://img.shields.io/pypi/status/fixdate
    :alt: PyPI - Status

'''
_INDEX_RST_BADGE_PYPI_WHEEL = '''.. image:: https://img.shields.io/pypi/wheel/fixdate
    :alt: PyPI - Wheel

'''
_INDEX_RST_BADGE_PYVERSIONS = '''.. image:: https://img.shields.io/pypi/pyversions/fixdate
...
.. image:: https://img.shields.io/pypi/status/fixdate
    :alt: PyPI - Status

.. image:: https://img.shields.io/pypi/wheel/fixdate
    :alt: PyPI - Wheel

.. image:: https://img.shields.io/pypi/pyversions/fixdate
    :alt: PyPI - Python Version

.. image:: https://img.shields.io/github/v/release/hendrikdutoit/fixdate
    :alt: GitHub release (latest by date)

.. image:: https://img.shields.io/github/license/hendrikdutoit/fixdate
    :alt: License

.. image:: https://img.shields.io/github/issues-raw/hendrikdutoit/fixdate
    :alt: GitHub issues

.. image:: https://img.shields.io/pypi/dm/fixdate
    :alt: PyPI - Downloads

.. image:: https://img.shields.io/github/search/hendrikdutoit/fixdate/GitHub hit
    :alt: GitHub Searches

.. image:: https://img.shields.io/codecov/c/gh/hendrikdutoit/fixdate
    :alt: CodeCov
    :target: https://app.codecov.io/gh/hendrikdutoit/fixdate

.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/fixdate/Pre-Commit
    :alt: GitHub Actions - Pre-Commit
    :target: https://github.com/hendrikdutoit/fixdate/actions/workflows/pre-commit.yaml

.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/fixdate/CI
    :alt: GitHub Actions - CI
    :target: https://github.com/hendrikdutoit/fixdate/actions/workflows/ci.yaml

.. image:: https://img.shields.io/testpypi/v/fixdate
    :alt: PyPi
